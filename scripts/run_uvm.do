...
vlog -sv +incdir+$env(QUESTA_HOME)/verilog_src/uvm-1.1d/src \
  rtl/ucie_ltsm_pkg.sv rtl/ucie_sb_sequencer.sv rtl/ucie_lfsr_training_engine.sv rtl/ucie_error_manager.sv rtl/ucie_ltsm.sv verification/ucie_ltsm_sva.sv \
