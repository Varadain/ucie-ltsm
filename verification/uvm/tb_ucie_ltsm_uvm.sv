...
module tb_ucie_ltsm_uvm;
  ...
  ucie_ltsm_sva #(.ALLOW_ABSTRACT_DATATRAIN_BYPASS(1'b1)) sva(.clk_i(clk),.rst_ni(intf.rst_n),.state_i(intf.state),
                    ...
                    .datatrain_phase_i(intf.datatrain_phase),
                    .sb_tx_valid_i(intf.sb_tx_valid),.sb_tx_ready_i(intf.sb_tx_ready),
                    .sb_tx_message_i(intf.sb_tx_message),.sb_rx_valid_i(intf.sb_rx_valid),
                    .sb_rx_message_i(intf.sb_rx_message),
