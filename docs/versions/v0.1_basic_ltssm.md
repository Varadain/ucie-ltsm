...
Version 0.2 is intended to add a real sideband sequencing layer to the existing controller. It remains planned until corresponding RTL and verification evidence exist.
