...
3. [Architecture](01_ucie_architecture/README.md) - what the reusable controller and FPGA CSR wrapper contain and what they abstract.
...
8. [Results](06_results/README.md) - reproducible Questa, CSR-wrapper, Quartus, waveform, and netlist evidence.
