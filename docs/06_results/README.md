...
| UVM regression | Questa 2023.3, bundled UVM 1.1d | Four tests pass; zero UVM errors/fatals | [Questa](questa.md) |
...
| Functional netlist | Quartus EDA Netlist Writer 23.1std.1 | Generated Verilog netlist retained with v0.1 | [Netlist](../../synthesis/quartus/netlists/v0.1-basic-ltssm/README.md) |
