...
\begin{figure*}[t]
\centering
\includegraphics[width=0.91\textwidth]{fig01_scope.pdf}
\caption{Implemented digital-control boundary. Gray/dashed content is not
implemented or inferred from the simulation and FPGA evidence.}
\label{fig:scope}
\end{figure*}
...
\begin{figure*}[t]
\centering
\includegraphics[width=0.91\textwidth]{fig02_rtl_architecture.pdf}
\caption{Modular RTL architecture. The wrapper does not alter the controller;
it serializes internal status through a compact CSR interface.}
\label{fig:rtl}
\end{figure*}
