...
The complete release gate is summarized in Fig.~\ref{fig:release-gate}. Trial
counts are not combined into a coverage percentage: the campaigns exercise
different interfaces and scenario spaces. Instead, the figure records which
directed, deterministic, randomized, predictor, assertion, and implementation
evidence was preserved together.

\begin{figure*}[t]
\centering
\includegraphics[width=0.93\textwidth]{fig12_regression_evidence.pdf}
\caption{Preserved release-gate evidence. Counts denote executed tests or
trials, not equivalent coverage units; explicit sampled counters replace an
unavailable native UCDB percentage.}
